...
include("new/connection.php");
	...
	if($username && $password)
	{
		...
		$studentquery=mysqli_query($con,"select * from student where matricno='$username' && password='$password'");
		...
		else
		{
			...
			else
			{
				...
				{
					$ictquery=mysqli_query($con,"select * from login_ict where username='$username' && password='$password'");
					...
					else
					{
						...
						if($foodlogin==1)
						{
							...
							header("location:new/biology/foodhome.php");
							//end of food home
						}
						else
						{
						...
						{
							$adminquery=mysqli_query($con,"select * from user where username='$username' && password='$password'");
							...
							else
							{
								...
								{
									$bursaryquery=mysqli_query($con,"select * from login_bursary where username='$username' && password='$password'");
									$bursarylogin=mysqli_num_rows($bursaryquery);
									if($bursarylogin==1)
									{
										//go to bursary home
										session_start();
										$_SESSION['bursarylogin']=$username;
										header("location:new/bursary/bursaryhome.php");
										//end of bursary home
									}
									else
									{
										...
										else
										{
											...
											{
												$hodquery=mysqli_query($con,"select * from login_hod where username='$username' && password='$password'");
