<?php
session_start();
if(!isset($_SESSION['bursarylogin']))
{
...
<body>
	...
	$clearancequery=mysqli_query($con,"select * from student_details where idnumber='$matricno'");
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:green">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="bursaryhome.php"><i class="fa fa-fw fa-dashboard"></i> <?php echo $_SESSION['bursarylogin']; ?> Home</a>
                    </li>
					
					<li>
                        <a href="bursaryclearedstudents.php"><i class="glyphicon glyphicon-thumbs-up"></i> Cleared Students</a>
                    </li>
					
					<li>
                        <a href="bursaryunclearedstudents.php"><i class="glyphicon glyphicon-thumbs-down"></i> Uncleared Students</a>
                    </li>
					<li class="active">
                        <a href="bursarybasket.php"><i class="glyphicon glyphicon-bullhorn"></i> Students Basket</a>
                    </li>
					<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">bursary Basket</h1>
						<p>
						<center>
						<form action="bursaryaddtobasket.php" method="post" style="width:100%;">
						...
						<textarea required style="width:100%;text-align:center;" name="basket" placeholder="enter the amount of items owed by the student "></textarea><br/><br/>
