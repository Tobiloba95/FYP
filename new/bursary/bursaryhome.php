    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:green">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="bursaryhome.php"><i class="fa fa-fw fa-dashboard"></i> <?php echo $_SESSION['financelogin']; ?> Home</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Bursary Page</h1>
						<p>
						Welcome to the e-clearance system. This system allows you to view the students; both cleared and uncleared, and gives you the ability to clear them or choose not to clear them. Use the menu on your left to navigate around this settings.
						</p>
                    </div>
                </div>
                <!-- /.row -->
