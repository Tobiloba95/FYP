    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">bursary Uncleared Students</h1>
						<p>
						<?php
						$year=date('Y');
						$query=mysqli_query($con,"select * from department_bursary where clearance_status='2'");
						$no=mysqli_num_rows($query);
						if($no==0)
						{
							echo"There are no students who have not been cleared in the bursary department";
						}
						else
						{
							echo"
