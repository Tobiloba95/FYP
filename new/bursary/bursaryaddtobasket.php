...
<body>
	...
	$clearancequery=mysqli_query($con,"select * from student where matricno='$username'");
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:green">
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['bursarylogin']; ?> admin <b class="caret"></b></a>
